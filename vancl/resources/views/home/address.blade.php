...
<div class="wrapper">
    ...
    <div class="right_cont">
        ...
        <div class="AsecurityBox02 AsecurityBox0212">
            <div class="aslevel">
                <em>安全级别：</em>
                <div class="asProgSpeed"  style="width:138px">
...
//                alert(id),
      ...
      <div    style="width: 100%;height: 50px;margin-bottom: 20px " >
       <p   style="width: 100%;height: 50px;line-height: 50px;text-align: center;font-size: 20px;border:solid 1px saddlebrown ; "  >添加新地址</p>
                            </div>

                                <form action="/myvancl/saveaddress/{{$userInfo['id']}}" method="post" ole="form">

                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <label for="">姓名</label>
                                        <input type="text" class="form-control" name="username" required="required" placeholder="请输入姓名">
                                        <br>
                                        <label for="">电话</label>
                                        <input type="text" class="form-control" name="phonenumber" required="required" placeholder="请输入电话号码">
                                        <br>

                                        <label for="">所在 省市</label>
                                        <input type="text" class="form-control" name="city" required="required" placeholder="请输入所在省 市">
                                        <br>
                                        <label for="">所在地区 </label>
                                        <input type="text" class="form-control" name="town" required="required" placeholder="请输入所在区">
                                        <br>
                                        <label for="">具体地址 街道门牌号 </label>
                                        <input type="text" class="form-control" name="street" required="required" placeholder="请输入具体地址">

                                    </div>

                                    <button  style="margin-left:300px;margin-bottom: 30px;" type="submit" class="btn btn-primary">保存新地址</button>
                                </form>
