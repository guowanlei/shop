...
<div class="wrapper">
    ...
    <div id="side-nav">
        ...
        <ul class="service-rate">
            ...
            <li class=""><a href="/myvancl/address/{{$userInfo['id']}}"   >  ·收货地址</a></li>

            <li class=""><a href="#" class="track"  style="color: red">  ·账户安全</a></li>
    ...
    <div class="right_cont">
      ...
      <div    style="width: 100%;height: 50px;margin-bottom: 20px " >
       <p   style="width: 100%;height: 50px;line-height: 50px;text-align: center;font-size: 20px;border:solid 1px saddlebrown ;">修改密码</p>
                            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="/userpassword/cheacknewpassword" method="post" role="form" class="form-horizontal">
                    {{csrf_field()}}
