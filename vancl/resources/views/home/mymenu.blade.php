...
<div class="wrapper">
    ...
    <div class="ordercontainer">
        ...
        <div class="wtitle">
           <h1   style="color: red;width: 100%;text-align: center;font-size: 20px"  >全部订单</h1>
        </div>
        ...
        <div id="orderlist">
                ...
                <table class="table table-hover">
                    ...
                    @foreach($myorder as $v)
                        <tr>
                            ...
                            <td>{{$v['total']}}元</td>
                            <td>{{$v['state']}}</td>
                            <td><a href="/myorder/Details/{{$v['ordernumber']}}">查看</a></td>
                        </tr>
         ...
         <div  style="color: red;font-size: 20px;"  >Welcome to Vancl 您还没有生成订单 <a href="/">快去购物吧。。。。。</a></div>
